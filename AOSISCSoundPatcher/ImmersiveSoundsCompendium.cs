...
namespace AOSISCSoundPatcher
{
    public static class ImmersiveSoundsCompendium
    {
        ...
        public static readonly Dictionary<IFormLinkGetter<IKeywordGetter>, IFormLink<IFootstepSetGetter>> FootstepSets = new Dictionary<IFormLinkGetter<IKeywordGetter>, IFormLink<IFootstepSetGetter>>()
        {
            ...
            { Update.Keyword.ArmorMaterialBlades,                     ImmersiveSoundsCompendium.FSTArmor_HeavyPlate },
            { Skyrim.Keyword.ArmorMaterialElven,                      ImmersiveSoundsCompendium.FSTArmor_Plate },
            { Skyrim.Keyword.ArmorMaterialElvenGilded,                ImmersiveSoundsCompendium.FSTArmor_Plate },
            { Skyrim.Keyword.ArmorMaterialGlass,                      ImmersiveSoundsCompendium.FSTArmor_Plate },
            ...
            { Skyrim.Keyword.ArmorNightingale,                        ImmersiveSoundsCompendium.FSTArmor_Leather },
            { Update.Keyword.ArmorMaterialThievesGuild,               ImmersiveSoundsCompendium.FSTArmor_Leather},
            { Dragonborn.Keyword.DLC2ArmorMaterialChitinLight,        ImmersiveSoundsCompendium.FSTArmor_Chitin },
            { Dawnguard.Keyword.DLC1ArmorMaterielFalmerHeavyOriginal, ImmersiveSoundsCompendium.FSTArmor_Chitin }
        };
